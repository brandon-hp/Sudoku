...
QT_MOC_LITERAL(1, 10, 10), // "FillSudoku"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 12), // "SubmitSudoku"
QT_MOC_LITERAL(4, 35, 12) // "ChangeSudoku"

    },
    "SudokuGUI\0FillSudoku\0\0SubmitSudoku\0"
    "ChangeSudoku"
};
...
void SudokuGUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SudokuGUI *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->FillSudoku(); break;
        case 1: _t->SubmitSudoku(); break;
        case 2: _t->ChangeSudoku((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject SudokuGUI::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_SudokuGUI.data,
    qt_meta_data_SudokuGUI,
    qt_static_metacall,
    nullptr,
    nullptr
} };
